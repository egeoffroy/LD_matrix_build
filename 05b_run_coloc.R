...
ld_matrix <- '/home/egeoffroy/LD_matrix/5kb_of_gene/AFA_chr_19_SL005223_ENSG00000104998_5kb_LD.ld.gz'
...
for(pop in pops){
	for(pop_size in pop_sample_sizes){
		...
		print(gwas_size)
		main(eqtl, gwas, gene='SL005223_ENSG00000104998', eqtlGeneCol= 'gene_id', eqtlMAFCol='maf', eqtlSeCol='se', eqtlBetaCol='slope', eqtlSampleSize= pop_size,
